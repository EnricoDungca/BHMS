...
class InventoryForm:
    ...
    def create_widgets(self):
        ...
        title = tk.Label(header_frame, text="Inventory Form",
        ...
        submit_btn = tk.Button(button_frame, text="Add Item", font=("Arial", 12),
    ...
    def create_inventory_section(self):
        ...
        for field in fields:
            ...
            if field == "Quantity" or field == "Unit Price" or field == "Total Price":
